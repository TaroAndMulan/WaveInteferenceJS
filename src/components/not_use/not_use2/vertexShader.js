...
void main() {
  ...
  float r = sqrt(modelPosition.x * modelPosition.x+modelPosition.z * modelPosition.z);
  if (step(r,wave_frequency*wave_length*u_time)>=1.0)
    modelPosition.y = sin(-1.0*r*2.0*3.14159/wave_length + 2.0*3.14159*wave_frequency* u_time + 3.14158/2.0) * wave_amplitude; 
